...
You can import the trait from: `revenantscholar_utils::snip12::StructHash`. And this implementation
...
use revenantscholar_utils::snip12::StructHash;
use starknet::ContractAddress;
...
[,cairo]
----
use revenantscholar_utils::snip12::SNIP12Metadata;
...
use core::hash::{HashStateExTrait, HashStateTrait};
use core::poseidon::PoseidonTrait;
use revenantscholar_utils::snip12::{SNIP12Metadata, StructHash, OffchainMessageHash};
use starknet::ContractAddress;
