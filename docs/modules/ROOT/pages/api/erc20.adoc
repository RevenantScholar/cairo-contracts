...
[.hljs-theme-dark]
```cairo
use revenantscholar_token::erc20::interface::IERC20Metadata;
```
...
TIP: You can use `revenantscholar_token::erc20::ERC20HooksEmptyImpl` which is already available as part of the library
for this purpose.
...
[.hljs-theme-dark]
```cairo
use revenantscholar_token::erc20::interface::IERC20Permit;
```
...
```cairo
use revenantscholar_presets::ERC20Upgradeable;
```
