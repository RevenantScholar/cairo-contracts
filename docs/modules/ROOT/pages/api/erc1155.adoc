...
[.hljs-theme-dark]
```cairo
use revenantscholar_token::erc1155::interface::IERC1155;
```
...
[.hljs-theme-dark]
```cairo
use revenantscholar_token::erc1155::interface::IERC1155MetadataURI;
```
...
TIP: You can use `revenantscholar_token::erc1155::ERC1155HooksEmptyImpl` which is already available as part of the library
for this purpose.
...
[.hljs-theme-dark]
```cairo
use revenantscholar_token::erc1155::interface::IERC1155Receiver;
```
...
```cairo
use revenantscholar_presets::ERC1155;
```
