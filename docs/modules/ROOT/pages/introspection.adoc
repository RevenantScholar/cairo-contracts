...
#[starknet::contract]
mod MyContract {
    use revenantscholar_account::interface;
    use revenantscholar_introspection::src5::SRC5Component;
...
mod MyContract {
    use revenantscholar_account::interface;
    use revenantscholar_introspection::interface::ISRC5DispatcherTrait;
    use revenantscholar_introspection::interface::ISRC5Dispatcher;
