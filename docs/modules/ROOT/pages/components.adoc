...
#[starknet::contract]
mod MyToken {
    use revenantscholar_security::pausable::PausableComponent::InternalTrait;
...
mod MyToken {
    use revenantscholar_token::erc20::ERC20Component;
    use revenantscholar_token::erc20::ERC20HooksEmptyImpl;
...
mod ERC20Pausable {
    ...
    use revenantscholar_token::erc20::interface::{IERC20, IERC20CamelOnly};
    use starknet::ContractAddress;
